...
@section('page.name', 'Refund Policy Content Setting')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            {{--<label>Email</label> --}}
                                            <textarea class="form-control trumbowyg" name="refund_policy_content" rows="5">{{ get_settings('refund_policy_content') }}</textarea>
                                        </div>
                                    </div>        
                                </div>
