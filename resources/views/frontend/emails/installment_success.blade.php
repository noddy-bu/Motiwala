                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td align="center" style="background:linear-gradient(135deg,#b8860b,#f2c94c); padding:30px;">
                            <img src="https://motiwalajewels.in/public/assets/img/logo.png" alt="Motiwala Jewels" width="120" style="display:block; margin-bottom:10px;">
                    ...
                    <tr>
                        <td style="padding:35px 30px;">
                            <h2 style="color:#b8860b; font-size:22px; margin-top:0; margin-bottom:10px;">
                                Congratulations!
                            </h2>
                            <p style="font-size:16px; color:#444; line-height:1.6; margin-bottom:20px;">
                                ...
                                <strong>{{ $amount }}</strong> for your plan 
                                <strong>“{{ $plan_name }}”</strong> has been successfully completed.
                            </p>

                            <p style="font-size:15px; color:#555; line-height:1.6;">
                                Thank you for choosing <strong>Motiwala Jewels</strong> and for trusting us on your beautiful journey.
                            </p>
                            ...
                            <p style="font-size:15px; color:#555; line-height:1.6;">
                                You can continue your journey towards your next installment with ease, or explore our latest collections for inspiration.
                            </p>

                            <p style="color:#888; font-size:14px; line-height:1.6; text-align:center; margin-top:40px;">
                                Warm regards,<br>
                    ...
                    <tr>
                        <td align="center" style="background:#fafafa; padding:20px; font-size:13px; color:#999;">
                            ...
                            <a href="https://treasure.motiwalajewels.in/" style="color:#b8860b; text-decoration:none;">Visit Website</a>
                        </td>
                    </tr>
                </table>
            </td>
