    ...
    <div class="main-form position-relative">
        ...
        <form action="{{$action}}" method="post" name="payuForm" class="pb-0">
           ...
           @if(!$hash)
            ...
            @endif
            <input name="surl" value="{{url(route('payumoney.success.installment'))}}" hidden/>
            <input name="furl" value="{{url(route('payumoney.fail.installment'))}}" hidden/>
            <input name="udf1" value="installment" hidden/>
