<div id="bg_theme" class="col-md-3 col-7 width20 bg-light bg_theme">
    <div id="sidebar" class="d-flex sidebar width80">
        <a href="/" class="d-block p-3 link-light" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
            <img class="sidebar_logo" src="http://127.0.0.1:8000/assets/frontend/images/logo.png">
        </a>
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start mx-1" id="menu">
            ...
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/myAccounts" class="nav-link align-middle px-0">
                    <i class="las la-user-plus"></i>
                    <span class="ms-1 d-sm-inline">Manage A/c &amp; Benefits</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/get-si-account-nos#autodebit_modal" class="nav-link align-middle px-0">
                    <i class="las la-credit-card"></i>
                    <span class="ms-1 d-sm-inline">Auto Debit</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/cancel-ach-si" class="nav-link align-middle px-0">
                    <i class="lab la-cc-mastercard"></i>
                    <span class="ms-1 d-sm-inline">Cancel ACH / Auto Debit (SI)</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/edituserprofile" class="nav-link align-middle px-0">
                    <i class="las la-user-circle"></i>
                    <span class="ms-1 d-sm-inline">Manage Profile</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/linkaccount" class="nav-link align-middle px-0">
                    <i class="las la-user-friends"></i>
                    <span class="ms-1 d-sm-inline">Group Account</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/oldschemeclosure" class="nav-link align-middle px-0">
                    <i class="las la-file-invoice"></i>
                    <span class="ms-1 d-sm-inline">Old Scheme Closure</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/terms-conditions" class="nav-link align-middle px-0">
                    <i class="las la-clipboard-list"></i>
                    <span class="ms-1 d-sm-inline">Terms and Conditions</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="http://127.0.0.1:8000/faq" class="nav-link align-middle px-0">
