                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                What is the Golden Treasure 11+1 Month Plan?                            
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Is Golden Treasure 11+1 Month Plan the same as an EMI (Equated Monthly Installment)
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                No. Our Golden Treasure 11+1 Month Plan is a savings plan, where you first save for 11+1 Month 
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How to enroll for Golden Treasure 11+1 Month Plan?
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                You can enroll for a Golden Treasure 11+1 Month Plan either at our store or online. Here's a
                                ...
                                <ol class="enrollment_list">
                                    ...
                                    <li>Once the payment is successful, you will have started your Golden Treasure 11+1 Month Plan.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFive">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Where can I find my Golden Treasure 11+1 Month Plan details after enrollment? 
                                What is the Golden Treasure 11+1 Month Plan passbook and how do I access it?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSix">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What is the minimum and maximum amount for Golden Treasure 11+1 Month Plan enrollment?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingEight">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I cancel/refund the Golden Treasure 11+1 Month Plan?
                            </button>
                        </h2>
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Our Golden Treasure 11+1 Month Plan cancellation/refund policy is available only after 6 
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingEleven">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I continue my Golden Treasure 11+1 Month Plan after 11+1 Month?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEighteen" class="accordion-collapse collapse" aria-labelledby="headingEighteen"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Yes, we offer an auto-debit feature for Golden Treasure 11+1 Month Plan installment payments.	
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwentyOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How can I redeem my Golden Treasure 11+1 Month Plan?
                            </button>
                        </h2>
                        <div id="collapseTwentyOne" class="accordion-collapse collapse" aria-labelledby="headingTwentyOne"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Your Golden Treasure 11+1 Month Plan will be auto redeemed on the maturity date. You can claim it by visiting our store.                             
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwentyTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What is the validity of my Golden Treasure 11+1 Month Plan? What happens if it is not used in the validity period?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwentyFive">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I redeem my plan and purchase before 11+1 Month?         
                            </button>
                        </h2>
                        <div id="collapseTwentyFive" class="accordion-collapse collapse" aria-labelledby="headingTwentyFive"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Yes, you can redeem your plan before 11+1 Month.However, you will not be eligible 
                                for discounts.                
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwentySix">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can the validity of my Golden Treasure 11+1 Month Plan be extended?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwentyEight">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I start a new plan with the Golden Treasure 11+1 Month Plan?
                            </button>
                        </h2>
